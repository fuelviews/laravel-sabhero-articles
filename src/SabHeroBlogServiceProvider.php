...
use Fuelviews\SabHeroBlog\Livewire\BeforeAfterSlider;
...
class SabHeroBlogServiceProvider extends PackageServiceProvider
{
    public function configurePackage(Package $package): void
    {
        $package->name('sabhero-blog')
            ->hasConfigFile(['sabhero-blog', 'feed'])
            ->hasMigrations([
                'create_blog_tables',
                'create_media_table',
    ...
    {
        Livewire::component('sabhero-blog::before-after-slider', BeforeAfterSlider::class);
    }
